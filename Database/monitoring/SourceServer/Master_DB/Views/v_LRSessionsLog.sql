...
WHERE   
 ...
 --and q.stored_proc NOT LIKE '%pj_CB_ArchiveDW_DestMove%' 
 --and q.stored_proc NOT LIKE '%pj_UntagImageMovement_DW%'
 --and  q.stored_proc NOT LIKE '%pj_TCL_SMS_Alert%'  
